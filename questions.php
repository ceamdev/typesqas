...
$sql_typeQA ="SELECT * FROM typequestionsanswers";
...
$sql1 = "INSERT INTO questions (question, answer, num_answer, option1, option2, option3, option4, option5, id_typeqas, id_quiz) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt1 = $mysqli->prepare($sql1);
$stmt1->bind_param("ssisssssii", $question, $answer, $num_answer, $option1, $option2, $option3, $option4, $option5, $id_typeqas, $id_quiz);
$stmt1->execute();
